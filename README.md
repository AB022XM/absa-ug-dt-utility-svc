...
To build the final jar and optimize the AbsaUGDTUtilitySvc application for production, run:
...
Then navigate to [http://localhost:1720](http://localhost:1720) in your browser.
